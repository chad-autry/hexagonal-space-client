...
module.exports = ngCore
    .Component({
        ...
        selector: 'hex-map',
        template: `
<canvas hexBoard resize hidpi="off" [style.display]="hexMapService.showMap?'inherit':'none'" style="background-color: black; width:100%; height:100%; position: absolute; left: 0px;top: 0px; z-index: -1;">
`
     })
    .Class({
